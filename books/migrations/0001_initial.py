    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secondary_genre', models.CharField(blank=True, choices=[('FANT', 'Fantasy'), ('CRIM', 'Crime & Thriller'), ('FICT', 'Fiction'), ('SCFI', 'Science Fiction'), ('HORR', 'Horror'), ('ROMA', 'Romance'), ('TEEN', 'Teen & Young Adult'), ('KIDS', "Children's Books"), ('ANIM', 'Anime & Manga'), ('OTHR', 'Others')], max_length=4, null=True)),
